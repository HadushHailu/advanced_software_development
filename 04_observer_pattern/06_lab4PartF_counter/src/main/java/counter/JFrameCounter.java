...
public class JFrameCounter extends JFrame {
    ...
    private void initObservers(){
        ICountObserver iCountObserver1;
        ICountObserver iCountObserver2;
        ICountObserver iCountObserver3;
        iCountObserver1 = new RectFrame();
        iCountObserver2 = new TextFrame();
        iCountObserver3 = new OvalFrame();
    ...
    private void jButtonIncrement_actionPerformed(ActionEvent e) {
        counter.increment();
        countObservable.setCount(counter.getCount());
    }
